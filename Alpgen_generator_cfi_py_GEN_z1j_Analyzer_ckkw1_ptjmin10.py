...
process.source = cms.Source("AlpgenSource",
        fileNames = cms.untracked.vstring('file:../Z1jets/z1j_ptjmin10')
)
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/afs/cern.ch/work/y/yunju/private/MySamples/AlpgenValid201407/GenSamples/Z1j_Alpgen_Pythia6_generator_cfi_py_GEN_ickkw1_ptjmin10.root'),
...
process.TFileService = cms.Service("TFileService",
                                       fileName = cms.string('histo_Z1j_Alpgen_Pythia6_generator_cfi_py_GEN_ickkw1_ptjmin10_match1.root')
  )
