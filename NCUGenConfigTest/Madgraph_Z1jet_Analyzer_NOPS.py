...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/afs/cern.ch/work/y/yunju/private/MySamples/AlpgenValid201407/GenSamples/Z1jetMadgraph_p6had_generator_cfi_py_GEN_Analyzer_matching_off_fortest.root'),
...
process.TFileService = cms.Service("TFileService",
                                       fileName = cms.string('histo_MadGraph_pythia6z1j_Pythia6_ps0_had0_ma0.root')
  )
